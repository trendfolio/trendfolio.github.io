...
import sys, os
sys.path.insert(0, '/Users/stevenmichiels/pst')


# do a relative import from the parent directory
from syscore.pdutils import calc_correlation
...
tickerselection = ['SPX','SMH','US10','XOM', 'CVX', 'GC']
...
p = Portfolio(weekly_returns_selection, risk_target=NO_RISK_TARGET)